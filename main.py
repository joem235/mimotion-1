...
min_dict = {time_list[0]: 4000, time_list[1]: 8000, time_list[2]: 15000, time_list[3]: 23000}
...
max_dict = {time_list[0]: 7999, time_list[1]: 14999, time_list[2]: 22999, time_list[3]: 29999}
# 设置结束
