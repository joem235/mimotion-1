...
min_dict = {time_list[0]: 4000, time_list[1]: 8000, time_list[2]: 13000, time_list[3]: 18000}
...
max_dict = {time_list[0]: 7999, time_list[1]: 12999, time_list[2]: 17999, time_list[3]: 23999}
# 设置结束
