...
min_dict = {time_list[0]: 4000, time_list[1]: 7000, time_list[2]: 13000, time_list[3]: 20000}
...
max_dict = {time_list[0]: 6999, time_list[1]: 12999, time_list[2]: 19999, time_list[3]: 29999}
# 设置结束
